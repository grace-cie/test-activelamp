...
import 'package:frontend/urlshort/config/colors.dart';
import 'package:frontend/urlshort/config/sizes.dart';
import 'package:frontend/urlshort/config/widgets.dart';
import 'package:frontend/urlshort/cubit/cubit.dart';
import 'package:frontend/urlshort/providers/provider.dart';
                                  ...
                                  child: RoundedLoadingButton(
                                    ...
                                    onPressed: () {
                                      if(formKey.currentState!.validate()){
                                        ...
                                        context.read<UrlCubit>().short(shorteurlcont.text);
                                      }
                                      sendURL.reset();
                                    },
                                    controller: sendURL, 
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            children: [
                              ...
                              // Center(
                              //   child: BlocBuilder<UrlCubit, String>(
                              //     builder: (context, state) {
                              //       return Text('$state', style: TextStyle(fontFamily: 'Prompt', color: colors.white));
                              //     },
                              //   ),
                              // )
                            ],
                    ...
                    builder: (context, state) {
                      return Positioned(
                        ...
                        child: Container(
                          ...
                          child: Center(
                            child: Text('$state', style: TextStyle(fontFamily: 'Prompt', color: colors.white))
                          ),
                        )
                      );
                    },
